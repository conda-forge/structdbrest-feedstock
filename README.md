About structdbrest-feedstock
============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/structdbrest-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12066&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/structdbrest-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `structdbrest` can be installed with `conda`:
...
```
mamba install structdbrest
```

It is possible to list all of the versions of `structdbrest` available on your platform with `conda`:
...
```
mamba search structdbrest --channel conda-forge
```
...
mamba repoquery search structdbrest --channel conda-forge

# List packages depending on `structdbrest`:
mamba repoquery whoneeds structdbrest --channel conda-forge

# List dependencies of `structdbrest`:
mamba repoquery depends structdbrest --channel conda-forge
```
